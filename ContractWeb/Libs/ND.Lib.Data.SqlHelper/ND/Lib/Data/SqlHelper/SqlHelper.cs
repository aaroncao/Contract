namespace ND.Lib.Data.SqlHelper
{
    using System;
    using System.Data;
    ...
    public sealed class SqlHelper
    {
        ...
        {
            return ExecuteDataset(connection, commandType, commandText, 300, commandParameters);
        }

        public static DataSet ExecuteDataset(SqlTransaction transaction, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            return ExecuteDataset(transaction, commandType, commandText, 300, commandParameters);
        }
        ...
        {
            return ExecuteNonQuery(connection, commandType, commandText, 300, commandParameters);
        }

        public static int ExecuteNonQuery(SqlTransaction transaction, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            return ExecuteNonQuery(transaction, commandType, commandText, 300, commandParameters);
        }
        ...
        public static int ExecuteNonQuery(SqlTransaction transaction, CommandType commandType, string commandText, int timeout, params SqlParameter[] commandParameters)
        {
            if (transaction == null)
            {
                throw new ArgumentNullException("transaction");
        ...
        {
            return ExecuteScalar(connection, commandType, commandText, 300, commandParameters);
        }

        public static object ExecuteScalar(SqlTransaction transaction, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            return ExecuteScalar(transaction, commandType, commandText, 300, commandParameters);
        }
        ...
        public static object ExecuteScalar(SqlConnection connection, CommandType commandType, string commandText, int timeout, params SqlParameter[] commandParameters)
        {
            if (connection == null)
            {
                throw new ArgumentNullException("connection");
        ...
        public static object ExecuteScalar(SqlTransaction transaction, CommandType commandType, string commandText, int timeout, params SqlParameter[] commandParameters)
        {
            if (transaction == null)
            {
                throw new ArgumentNullException("transaction");
